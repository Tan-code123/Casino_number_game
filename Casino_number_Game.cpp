...
int main()
{
 ...
 cout<<"Enter Bid Amount: $";
        ...
        if(dice == guess)
        {
            cout <<"\nHurray You Won " << bidamnt * 10<<"Rs.";
            amnt = amnt + bidamnt * 10;
        }
        else
        {
            cout << "Sorry You Lose "<< bidamnt <<"Rs.\n";
            amnt = amnt - bidamnt;
        }

        cout << "\nThe Winning Number Was: " << dice <<"\n";
        cout << "\n"<<name<<", Your Remaining Amount Is " << amnt << "Rs.\n";
        if(amnt == 0)
        {
    ...
    cout<<"\n===============================================================================================\n";
    cout << "Thanks For Playing Game Again Your Current Amount Is " << amnt << "Rs.";
    cout<<"\n===============================================================================================\n";
